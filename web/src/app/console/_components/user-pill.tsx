    ...
    <UserButton
      ...
      classNames={{
        ...
        content: {
          user: { base: "none" },
          separator: "none",
          base: "origin-top-right rounded-xl border border-[var(--border)] bg-[var(--surface)] text-[var(--text)] shadow-xl shadow-black/10 data-[state=open]:animate-pop-in data-[state=closed]:animate-pop-out",
        },
      }}
    />
  );
